...
JOB_NAME = "exp19_natural_pressure_soft_anchor_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 19 - natural-order surface-to-surface contact Abaqus model\n")
        ...
        f.write("*Static, stabilize=5.0e-3\n1.0e-4, 1.0, 1.0e-14, 5.0e-4\n")
        f.write("*Cload\n")
