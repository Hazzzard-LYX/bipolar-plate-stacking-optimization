...
JOB = sys.argv[1] if len(sys.argv) > 1 else 'exp34_exact_max_explicit_smallslip_friction_contact'
STACK_ORDER = eval(sys.argv[2]) if len(sys.argv) > 2 else [11, 1, 2, 10, 14, 9, 13, 7, 5, 6, 3, 15, 8, 4, 12]
NX = 17
NY = 9
