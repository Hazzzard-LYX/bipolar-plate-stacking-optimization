...
JOB_NAME = "exp34_exact_min_explicit_smallslip_friction_contact"
INP_PATH = os.path.join(OUTPUT_DIR, JOB_NAME + ".inp")

STACK_ORDER = [2, 14, 3, 5, 4, 12, 11, 8, 13, 1, 10, 7, 9, 15, 6]
LENGTH_M = 0.820
WIDTH_M = 0.345
RAW_NX = 201
RAW_NY = 85
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 34 - exact min-distance-sum small-sliding friction Explicit contact model\n")
