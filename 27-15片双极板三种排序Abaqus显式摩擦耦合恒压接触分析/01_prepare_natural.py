...
JOB_NAME = "exp27_natural_explicit_friction_pressure0448_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 27 - natural-order friction-coupled Explicit contact model\n")
        ...
        f.write(", %.10e\n" % STEP_TIME_S)
        f.write("*Contact Pair, interaction=LINEAR_FRICTIONLESS\n")
