...
JOB_NAME = "exp23_natural_explicit_damped_pressure0448_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 23 - natural-order damped Explicit quasi-static pressure contact model\n")
        ...
        f.write("*Output, history, time interval=5.0e-3\n")
