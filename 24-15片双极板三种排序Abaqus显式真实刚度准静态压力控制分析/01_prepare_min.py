...
JOB_NAME = "exp24_min_explicit_titanium_pressure0448_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 24 - min-distance-sum titanium-stiffness Explicit quasi-static pressure contact model\n")
