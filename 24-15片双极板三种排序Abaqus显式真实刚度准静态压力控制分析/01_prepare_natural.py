...
JOB_NAME = "exp24_natural_explicit_titanium_pressure0448_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 24 - natural-order titanium-stiffness Explicit quasi-static pressure contact model\n")
        ...
        f.write("*Output, history, time interval=2.5e-3\n")
