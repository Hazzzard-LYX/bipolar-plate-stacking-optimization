...
JOB_NAME = "exp22_natural_explicit_pressure0448_anchor_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 22 - natural-order Explicit quasi-static pressure contact model\n")
        ...
        f.write("*Output, history, time interval=1.0e-3\n")
