...
JOB_NAME = "exp9_natural_soft_contact"
...
GRAVITY = 9.8
CONTACT_STIFFNESS_PA_PER_M = 5.0e6
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 9 - natural-order soft-contact Abaqus model\n")
        ...
        f.write("*Static, stabilize=2.0e-3\n1.0e-3, 1.0, 1.0e-14, 1.0e-3\n")
        f.write("*Boundary\n")
        f.write("EP_TOP_RP, 3, 3, %.10e\n" % TOP_DISPLACEMENT_M)
        f.write("*Dload\n")
        for i in range(len(plates)):
    ...
    print("Rigid endplate reference displacement: %.6e m" % TOP_DISPLACEMENT_M)
