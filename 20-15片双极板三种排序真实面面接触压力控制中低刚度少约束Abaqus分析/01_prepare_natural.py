...
JOB_NAME = "exp20_natural_pressure_midsoft_anchor_contact"
...
def write_inp():
    ...
    with open(INP_PATH, "w") as f:
        f.write("*Heading\n")
        f.write("Experiment 20 - natural-order surface-to-surface contact Abaqus model\n")
