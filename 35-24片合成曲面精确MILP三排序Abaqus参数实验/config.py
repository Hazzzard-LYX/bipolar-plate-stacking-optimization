# -*- coding: utf-8 -*-
EXPERIMENT_ID = 35
DESCRIPTION = "Exact MILP reorder of Experiment 30 using identical 24 surfaces and physics"
PLATE_COUNT = 24
SOURCE_EXPERIMENT_ID = 30
...
EXACT_SOLVER_TIME_LIMIT_S = 7200.0
EXACT_SOLVER_MIP_GAP = 0.0
